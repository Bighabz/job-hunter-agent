        ...
        {!configSaved && (
          <div style={{ background: "#12121a", border: "1px solid #1e1e2e", borderRadius: "12px", padding: "28px", marginBottom: "24px" }}>
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              <input value={config.url} onChange={e => setConfig(p => ({ ...p, url: e.target.value }))} placeholder="https://project.supabase.co" style={{ ...inputStyle, flex: "1 1 300px", padding: "10px 14px", fontSize: "13px" }} />
