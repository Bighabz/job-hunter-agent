...
- Incident reporting
- Patrol operations
- Visitor management / credential verification
- Screening operations (magnetometer, X-ray)
- De-escalation
...
- Savage III / Union Pacific armed security (current, direct match)
- Prior security roles (ADT, United Security)
- Any law enforcement adjacent training (PC 832)

## Experience to Include but Secondary
- IT/cybersecurity education (physical + cyber convergence angle)
- SOC experience (insider threat awareness, access monitoring)

## Experience to De-Emphasize
- AI projects (keep to one line max)
- Crypto/DeFi (omit entirely)
